    ...
    return (
        <div id='banner' className='w-full h-96 mb-10 mt-10 transition-all flex flex-col justify-center border border-amber-700'>
            ...
            <div className='flex w-2/5 justify-around items-center '>
                <p className='text-white text-xl uppercase border-white border-dashed border-b-2 border-t-2 text-center py-2 rounded-lg w-72'>So want to know <span className='text-yellow-400'>more</span> ?</p>
                <a href="#cookingHistory">
                    <button className='p-3 bg-white font-semibold w-48 border border-amber-700 transition-all hover:bg-amber-600 hover:text-white hover:border-slate-300 active:border-amber-700 active:text-black active:bg-white'>Cooking History</button>
                </a>
            </div>
        </div>
    );
