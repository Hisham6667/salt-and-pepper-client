...
const Banner = () => {
    return (
        <div id='banner' className='w-full h-96 my-5 transition-all flex flex-col justify-center border border-amber-700'>
            <p className='text-white text-4xl w-2/3 mx-5 mt-5 uppercase'>Hey There! Welcome to this kitchen</p>
            ...
            <div className='flex w-2/5 justify-around items-center '>
                <p className='text-white text-2xl uppercase'>So want to be <span className='text-slate-300'>chef</span> ?</p>
                <a href="#contact">
